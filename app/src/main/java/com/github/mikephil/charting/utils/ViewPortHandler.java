...
public class ViewPortHandler {
    ...
    public android.graphics.PointF getContentCenter() {
        return new android.graphics.PointF(mContentRect.centerX(), mContentRect.centerY());
    }
     ...
     * @param y
     */
    public android.graphics.Matrix zoomIn(float x, float y) {

        android.graphics.Matrix save = new android.graphics.Matrix();
     ...
     * center.
     */
    public android.graphics.Matrix zoomOut(float x, float y) {
     ...
     * @param y
     */
    public android.graphics.Matrix zoom(float scaleX, float scaleY, float x, float y) {
    ...
    public android.graphics.Matrix fitScreen() {
        ...
        vals[android.graphics.Matrix.MTRANS_X] = 0f;
        vals[android.graphics.Matrix.MTRANS_Y] = 0f;
        vals[android.graphics.Matrix.MSCALE_X] = 1f;
        vals[android.graphics.Matrix.MSCALE_Y] = 1f;
     ...
     * @return save
     */
    public synchronized void centerViewPort(final float[] transformedPts, final android.view.View view) {
     ...
     * @param matrix
     */
    public void limitTransAndScale(android.graphics.Matrix matrix, android.graphics.RectF content) {

        float[] vals = new float[9];
        matrix.getValues(vals);

        float curTransX = vals[android.graphics.Matrix.MTRANS_X];
        float curScaleX = vals[android.graphics.Matrix.MSCALE_X];

        float curTransY = vals[android.graphics.Matrix.MTRANS_Y];
        float curScaleY = vals[android.graphics.Matrix.MSCALE_Y];
        ...
        vals[android.graphics.Matrix.MTRANS_X] = mTransX;
        vals[android.graphics.Matrix.MSCALE_X] = mScaleX;

        vals[android.graphics.Matrix.MTRANS_Y] = mTransY;
        vals[android.graphics.Matrix.MSCALE_Y] = mScaleY;
