 ...
 */
public class PieRadarChartTouchListener extends ChartTouchListener<com.github.mikephil.charting.charts.PieRadarChartBase<?>> {
    ...
    private java.util.ArrayList<AngularVelocitySample> _velocitySamples = new java.util.ArrayList<AngularVelocitySample>();
