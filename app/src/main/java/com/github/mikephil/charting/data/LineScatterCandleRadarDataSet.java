...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> {
    ...
    protected android.graphics.DashPathEffect mHighlightDashPathEffect = null;


    public LineScatterCandleRadarDataSet(java.util.List<T> yVals, String label) {
        super(yVals, label);
    ...
    public void enableDashedHighlightLine(float lineLength, float spaceLength, float phase) {
        mHighlightDashPathEffect = new android.graphics.DashPathEffect(new float[] {
