...
public class YAxisRenderer extends AxisRenderer {
    ...
    public YAxisRenderer(com.github.mikephil.charting.utils.ViewPortHandler viewPortHandler, YAxis yAxis, com.github.mikephil.charting.utils.Transformer trans) {
    ...
    public void computeAxis(float yMin, float yMax) {
        ...
        if (mViewPortHandler.contentWidth() > 10 && !mViewPortHandler.isFullyZoomedOutY()) {
            ...
            com.github.mikephil.charting.utils.PointD p1 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentTop());
            com.github.mikephil.charting.utils.PointD p2 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(), mViewPortHandler.contentBottom());
    ...
    protected void computeAxisValues(float min, float max) {
        ...
        double interval = com.github.mikephil.charting.utils.Utils.roundToNextSignificant(rawInterval);
        ...
        if (mYAxis.isForceLabelsEnabled()) {
            ...
            if (mYAxis.isShowOnlyMinMaxEnabled()) {
                ...
                double last = com.github.mikephil.charting.utils.Utils.nextUp(Math.floor(yMax / interval) * interval);
    ...
    public void renderAxisLabels(android.graphics.Canvas c) {
        ...
        float yoffset = com.github.mikephil.charting.utils.Utils.calcTextHeight(mAxisLabelPaint, "A") / 2.5f + mYAxis.getYOffset();
    ...
    public void renderLimitLines(android.graphics.Canvas c) {
        ...
        java.util.List<LimitLine> limitLines = mYAxis.getLimitLines();
