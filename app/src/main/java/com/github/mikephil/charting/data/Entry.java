 ...
 */
public class Entry implements android.os.Parcelable {
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        if (mData != null) {
            if (mData instanceof android.os.Parcelable) {
                dest.writeInt(1);
                dest.writeParcelable((android.os.Parcelable) this.mData, flags);
            } else {
    ...
    public static final Creator<Entry> CREATOR = new Creator<Entry>() {
        public Entry createFromParcel(android.os.Parcel source) {
