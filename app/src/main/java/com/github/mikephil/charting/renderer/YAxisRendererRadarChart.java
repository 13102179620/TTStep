...
public class YAxisRendererRadarChart extends YAxisRenderer {
    ...
    public YAxisRendererRadarChart(com.github.mikephil.charting.utils.ViewPortHandler viewPortHandler, YAxis yAxis, com.github.mikephil.charting.charts.RadarChart chart) {
    ...
    public void renderAxisLabels(android.graphics.Canvas c) {
        ...
        for (int j = 0; j < labelCount; j++) {
            ...
            android.graphics.PointF p = com.github.mikephil.charting.utils.Utils.getPosition(center, r, mChart.getRotationAngle());
    ...
    public void renderLimitLines(android.graphics.Canvas c) {
        ...
        for (int i = 0; i < limitLines.size(); i++) {
            ...
            android.graphics.Path limitPath = new android.graphics.Path();

            for (int j = 0; j < mChart.getData().getXValCount(); j++) {

                android.graphics.PointF p = com.github.mikephil.charting.utils.Utils.getPosition(center, r, sliceangle * j + mChart.getRotationAngle());
