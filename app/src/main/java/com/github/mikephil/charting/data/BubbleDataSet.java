...
public class BubbleDataSet extends BarLineScatterCandleBubbleDataSet<BubbleEntry> {
    ...
    public BubbleDataSet(java.util.List<BubbleEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    protected void calcMinMax(int start, int end) {
        ...
        final java.util.List<BubbleEntry> entries = getYVals();
    ...
    public DataSet<BubbleEntry> copy() {
        ...
        java.util.List<BubbleEntry> yVals = new java.util.ArrayList<BubbleEntry>();
