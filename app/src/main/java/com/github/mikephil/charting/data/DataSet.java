...
public abstract class DataSet<T extends Entry> {
     ...
     */
    protected java.util.List<Integer> mColors = null;

    /**
     * the entries that this dataset represents / holds together
     */
    protected java.util.List<T> mYVals = null;
     ...
     */
    private int mValueColor = android.graphics.Color.BLACK;
     ...
     */
    private android.graphics.Typeface mValueTypeface;
     ...
     * @param label
     */
    public DataSet(java.util.List<T> yVals, String label) {

        this.mLabel = label;
        this.mYVals = yVals;

        if (mYVals == null)
            mYVals = new java.util.ArrayList<T>();

        mColors = new java.util.ArrayList<Integer>();

        // default color
        mColors.add(android.graphics.Color.rgb(140, 234, 255));
     ...
     * @return
     */
    public java.util.List<T> getEntriesForXIndex(int x) {

        java.util.List<T> entries = new java.util.ArrayList<T>();
     ...
     * @return
     */
    public java.util.List<T> getYVals() {
        return mYVals;
    }
     ...
     * @param colors
     */
    public void setColors(java.util.List<Integer> colors) {
        this.mColors = colors;
    }
     ...
     * @param colors
     */
    public void setColors(int[] colors, android.content.Context c) {
