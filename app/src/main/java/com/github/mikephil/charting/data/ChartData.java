...
public abstract class ChartData<T extends DataSet<? extends Entry>> {
     ...
     */
    protected java.util.List<String> mXVals;
    ...
    public ChartData() {
        mXVals = new java.util.ArrayList<String>();
        mDataSets = new java.util.ArrayList<T>();
    }
     ...
     * @param xVals
     */
    public ChartData(java.util.List<String> xVals) {
        this.mXVals = xVals;
        this.mDataSets = new java.util.ArrayList<T>();
        init();
    }
     ...
     */
    public ChartData(java.util.List<String> xVals, java.util.List<T> sets) {
        this.mXVals = xVals;
        this.mDataSets = sets;
     ...
     * @param sets  the dataset array
     */
    public ChartData(String[] xVals, java.util.List<T> sets) {
        this.mXVals = arrayToList(xVals);
        this.mDataSets = sets;
     ...
     * @return
     */
    private java.util.List<String> arrayToList(String[] array) {
     ...
     * @return
     */
    public java.util.List<String> getXVals() {
        return mXVals;
    }
     ...
     * @return
     */
    protected int getDataSetIndexByLabel(java.util.List<T> dataSets, String label,
                                         boolean ignorecase) {
    ...
    public int[] getColors() {
        ...
        for (int i = 0; i < mDataSets.size(); i++) {
            ...
            java.util.List<Integer> clrs = mDataSets.get(i).getColors();
     ...
     * @return
     */
    public static java.util.List<String> generateXVals(int from, int to) {

        java.util.List<String> xvals = new java.util.ArrayList<String>();
