...
public class Approximator {
     ...
     * @return
     */
    public java.util.List<Entry> filter(java.util.List<Entry> points) {
     ...
     * @return
     */
    public java.util.List<Entry> filter(java.util.List<Entry> points, double tolerance) {
     ...
     * @return
     */
    private java.util.List<Entry> reduceWithDouglasPeuker(java.util.List<Entry> entries, double epsilon) {
        ...
        java.util.List<Entry> reducedEntries = new java.util.ArrayList<Entry>();
     ...
     * @param end
     */
    private void algorithmDouglasPeucker(java.util.List<Entry> entries, double epsilon, int start,
                                         int end) {
        if (end <= start + 1) {
            // recursion finished
            return;
