...
public class Legend extends ComponentBase {
    ...
    public Legend() {
        ...
        mFormSize = com.github.mikephil.charting.utils.Utils.convertDpToPixel(8f);
        mXEntrySpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(6f);
        mYEntrySpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(0f);
        mFormToTextSpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(5f);
        mTextSize = com.github.mikephil.charting.utils.Utils.convertDpToPixel(10f);
        mStackSpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(3f);
        this.mXOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(5f);
        this.mYOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(7f);
    }
     ...
     * @param labels
     */
    public Legend(java.util.List<Integer> colors, java.util.List<String> labels) {
        this();
        ...
        this.mColors = com.github.mikephil.charting.utils.Utils.convertIntegers(colors);
        this.mLabels = com.github.mikephil.charting.utils.Utils.convertStrings(labels);
    }
     ...
     * @param colors
     */
    public void setComputedColors(java.util.List<Integer> colors) {
        mColors = com.github.mikephil.charting.utils.Utils.convertIntegers(colors);
    }
     ...
     * @param labels
     */
    public void setComputedLabels(java.util.List<String> labels) {
        mLabels = com.github.mikephil.charting.utils.Utils.convertStrings(labels);
    }
    ...
    public float getMaximumEntryWidth(android.graphics.Paint p) {
        ...
        for (int i = 0; i < mLabels.length; i++) {
            ...
            if (mLabels[i] != null) {
                ...
                float length = (float) com.github.mikephil.charting.utils.Utils.calcTextWidth(p, mLabels[i]);
     ...
     * @return
     */
    public float getMaximumEntryHeight(android.graphics.Paint p) {
        ...
        for (int i = 0; i < mLabels.length; i++) {
            ...
            if (mLabels[i] != null) {
                ...
                float length = (float) com.github.mikephil.charting.utils.Utils.calcTextHeight(p, mLabels[i]);
     ...
     */
    public void setExtra(java.util.List<Integer> colors, java.util.List<String> labels) {
        this.mExtraColors = com.github.mikephil.charting.utils.Utils.convertIntegers(colors);
        this.mExtraLabels = com.github.mikephil.charting.utils.Utils.convertStrings(labels);
    }
     ...
     * notifyDataSetChanged() is needed to auto-calculate the legend again)
     */
    public void setCustom(java.util.List<Integer> colors, java.util.List<String> labels) {
    ...
    public void setFormSize(float size) {
        mFormSize = com.github.mikephil.charting.utils.Utils.convertDpToPixel(size);
    }
    ...
    public void setXEntrySpace(float space) {
        mXEntrySpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(space);
    }
    ...
    public void setYEntrySpace(float space) {
        mYEntrySpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(space);
    }
    ...
    public void setFormToTextSpace(float space) {
        this.mFormToTextSpace = com.github.mikephil.charting.utils.Utils.convertDpToPixel(space);
    }
     ...
     * @return
     */
    public float getFullWidth(android.graphics.Paint labelpaint) {
        ...
        for (int i = 0; i < mLabels.length; i++) {
            ...
            if (mLabels[i] != null) {
                ...
                if (mColors[i] != com.github.mikephil.charting.utils.ColorTemplate.COLOR_SKIP)
                    width += mFormSize + mFormToTextSpace;

                width += com.github.mikephil.charting.utils.Utils.calcTextWidth(labelpaint, mLabels[i]);
    ...
    public float getFullHeight(android.graphics.Paint labelpaint) {
        ...
        for (int i = 0; i < mLabels.length; i++) {
            ...
            if (mLabels[i] != null) {
                ...
                height += com.github.mikephil.charting.utils.Utils.calcTextHeight(labelpaint, mLabels[i]);
    ...
    private com.github.mikephil.charting.utils.FSize[] mCalculatedLabelSizes = new com.github.mikephil.charting.utils.FSize[] {};
    private Boolean[] mCalculatedLabelBreakPoints = new Boolean[] {};
    private com.github.mikephil.charting.utils.FSize[] mCalculatedLineSizes = new com.github.mikephil.charting.utils.FSize[] {};
     ...
     * @param labelpaint
     */
    public void calculateDimensions(android.graphics.Paint labelpaint, com.github.mikephil.charting.utils.ViewPortHandler viewPortHandler) {
        ...
        if (mPosition == LegendPosition.RIGHT_OF_CHART
            ...
            float labelLineHeight = com.github.mikephil.charting.utils.Utils.getLineHeight(labelpaint);
            float labelLineSpacing = com.github.mikephil.charting.utils.Utils.getLineSpacing(labelpaint) + mYEntrySpace;
            float contentWidth = viewPortHandler.contentWidth();

            // Prepare arrays for calculated layout
            java.util.ArrayList<com.github.mikephil.charting.utils.FSize> calculatedLabelSizes = new java.util.ArrayList<com.github.mikephil.charting.utils.FSize>(labelCount);
            java.util.ArrayList<Boolean> calculatedLabelBreakPoints = new java.util.ArrayList<Boolean>(labelCount);
            java.util.ArrayList<com.github.mikephil.charting.utils.FSize> calculatedLineSizes = new java.util.ArrayList<com.github.mikephil.charting.utils.FSize>();
            ...
            for (int i = 0; i < labelCount; i++) {
                ...
                boolean drawingForm = mColors[i] != com.github.mikephil.charting.utils.ColorTemplate.COLOR_SKIP;
                ...
                if (mLabels[i] != null) {
                    ...
                    calculatedLabelSizes.add(com.github.mikephil.charting.utils.Utils.calcTextSize(labelpaint, mLabels[i]));
                    requiredWidth += drawingForm ? mFormToTextSpace + mFormSize : 0.f;
                    requiredWidth += calculatedLabelSizes.get(i).width;
                } else {

                    calculatedLabelSizes.add(new com.github.mikephil.charting.utils.FSize(0.f, 0.f));
                ...
                if (mLabels[i] != null || i == labelCount - 1) {
                                                                                                  ...
                                                                                                  // fits
                    {
                        ...
                        calculatedLineSizes.add(new com.github.mikephil.charting.utils.FSize(currentLineWidth, labelLineHeight));
            ...
            mCalculatedLabelSizes = calculatedLabelSizes.toArray(
                    new com.github.mikephil.charting.utils.FSize[calculatedLabelSizes.size()]);
            ...
            mCalculatedLineSizes = calculatedLineSizes
                    .toArray(new com.github.mikephil.charting.utils.FSize[calculatedLineSizes.size()]);
