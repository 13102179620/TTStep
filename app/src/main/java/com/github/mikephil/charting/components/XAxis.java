...
public class XAxis extends AxisBase {
    ...
    protected java.util.List<String> mValues = new java.util.ArrayList<String>();
     ...
     */
    protected com.github.mikephil.charting.formatter.XAxisValueFormatter mXAxisValueFormatter = new com.github.mikephil.charting.formatter.DefaultXAxisValueFormatter();
    ...
    public XAxis() {
        ...
        mYOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(4.f);
    }
     ...
     * @param formatter
     */
    public void setValueFormatter(com.github.mikephil.charting.formatter.XAxisValueFormatter formatter) {
        if(formatter == null)
            mXAxisValueFormatter = new com.github.mikephil.charting.formatter.DefaultXAxisValueFormatter();
        else
     ...
     * @return
     */
    public com.github.mikephil.charting.formatter.XAxisValueFormatter getValueFormatter() {
