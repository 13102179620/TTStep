...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public YAxisRendererHorizontalBarChart(com.github.mikephil.charting.utils.ViewPortHandler viewPortHandler, YAxis yAxis,
    ...
    public void computeAxis(float yMin, float yMax) {
        ...
        if (mViewPortHandler.contentHeight() > 10 && !mViewPortHandler.isFullyZoomedOutX()) {
            ...
            com.github.mikephil.charting.utils.PointD p1 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentLeft(),
                                                                                        mViewPortHandler.contentTop());
            com.github.mikephil.charting.utils.PointD p2 = mTrans.getValuesByTouchPoint(mViewPortHandler.contentRight(),
                                                                                        mViewPortHandler.contentTop());
    ...
    public void renderAxisLabels(android.graphics.Canvas c) {
        ...
        float baseYOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(2.5f);
        float textHeight = com.github.mikephil.charting.utils.Utils.calcTextHeight(mAxisLabelPaint, "Q");
    ...
    public void renderLimitLines(android.graphics.Canvas c) {
        ...
        for (int i = 0; i < limitLines.size(); i++) {
            ...
            if (label != null && !label.equals("")) {
                ...
                float yOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(2f) + l.getYOffset();
