...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
	...
	public Highlight getHighlight(float x, float y) {
		...
		if (h == null)
			...
			com.github.mikephil.charting.data.BarDataSet set = mChart.getBarData().getDataSetByIndex(h.getDataSetIndex());
	 ...
	 * @return
	 */
	protected Highlight getStackedHighlight(Highlight old, com.github.mikephil.charting.data.BarDataSet set, int xIndex, int dataSetIndex, double yValue) {

		com.github.mikephil.charting.data.BarEntry entry = set.getEntryForXIndex(xIndex);
	 ...
	 * @return
	 */
	protected Range[] getRanges(com.github.mikephil.charting.data.BarEntry entry) {
