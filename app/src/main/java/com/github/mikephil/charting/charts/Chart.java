...
public abstract class Chart<T extends com.github.mikephil.charting.data.ChartData<? extends com.github.mikephil.charting.data.DataSet<? extends com.github.mikephil.charting.data.Entry>>> extends
     ...
     */
    public Chart(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     */
    public Chart(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mViewPortHandler = new com.github.mikephil.charting.utils.ViewPortHandler();

        mLegend = new Legend();

        mLegendRenderer = new LegendRenderer(mViewPortHandler, mLegend);

        mDescPaint = new android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG);
        mDescPaint.setColor(android.graphics.Color.BLACK);
        mDescPaint.setTextAlign(android.graphics.Paint.Align.RIGHT);
        mDescPaint.setTextSize(com.github.mikephil.charting.utils.Utils.convertDpToPixel(9f));

        mInfoPaint = new android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG);
        mInfoPaint.setColor(android.graphics.Color.rgb(247, 189, 51)); // orange
        mInfoPaint.setTextAlign(android.graphics.Paint.Align.CENTER);
        mInfoPaint.setTextSize(com.github.mikephil.charting.utils.Utils.convertDpToPixel(12f));
    ...
    public void setData(T data) {
        ...
        for (com.github.mikephil.charting.data.DataSet<?> set : mData.getDataSets()) {
    ...
    protected void calculateFormatter(float min, float max) {
        ...
        int digits = com.github.mikephil.charting.utils.Utils.getDecimals(reference);
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        if (mDataNotSet || mData == null || mData.getYValCount() <= 0) { // check
            ...
            if (!android.text.TextUtils.isEmpty(mNoDataTextDescription)) {
     ...
     */
    protected void drawDescription(android.graphics.Canvas c) {
    ...
    public void highlightValue(Highlight high, boolean callListener) {
        ...
        com.github.mikephil.charting.data.Entry e = null;
        ...
        if (high == null)
            ...
            if (mLogEnabled)
                android.util.Log.i(LOG_TAG, "Highlighted: " + high.toString());
    ...
    protected void drawMarkers(android.graphics.Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (xIndex <= mDeltaX && xIndex <= mDeltaX * mAnimator.getPhaseX()) {
                ...
                com.github.mikephil.charting.data.Entry e = mData.getEntryForHighlight(mIndicesToHighlight[i]);
     ...
     * @return
     */
    protected abstract float[] getMarkerPosition(com.github.mikephil.charting.data.Entry e, Highlight highlight);
...
//    }
    ...
    public android.graphics.PointF getCenter() {
        return new android.graphics.PointF(getWidth() / 2f, getHeight() / 2f);
    }
    ...
    public void setDescriptionPosition(float x, float y) {
        mDescriptionPosition = new android.graphics.PointF(x, y);
    }
     ...
     * @param t
     */
    public void setDescriptionTypeface(android.graphics.Typeface t) {
    ...
    public void setDescriptionTextSize(float size) {
        ...
        mDescPaint.setTextSize(com.github.mikephil.charting.utils.Utils.convertDpToPixel(size));
    }
    ...
    public void setExtraTopOffset(float offset) {
        mExtraTopOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(offset);
    }
    ...
    public void setExtraRightOffset(float offset) {
        mExtraRightOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(offset);
    }
    ...
    public void setExtraBottomOffset(float offset) {
        mExtraBottomOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(offset);
    }
    ...
    public void setExtraLeftOffset(float offset) {
        mExtraLeftOffset = com.github.mikephil.charting.utils.Utils.convertDpToPixel(offset);
    }
     ...
     *              ...
     */
    public void setPaint(android.graphics.Paint p, int which) {
     ...
     * @return
     */
    public java.util.List<com.github.mikephil.charting.data.Entry> getEntriesAtIndex(int xIndex) {

        java.util.List<com.github.mikephil.charting.data.Entry> vals = new java.util.ArrayList<com.github.mikephil.charting.data.Entry>();

        for (int i = 0; i < mData.getDataSetCount(); i++) {

            com.github.mikephil.charting.data.DataSet<? extends com.github.mikephil.charting.data.Entry> set = mData.getDataSetByIndex(i);
    ...
    public android.graphics.Bitmap getChartBitmap() {
        ...
        android.graphics.Bitmap returnedBitmap = android.graphics.Bitmap.createBitmap(getWidth(), getHeight(), android.graphics.Bitmap.Config.RGB_565);
        // Bind a canvas to it
        android.graphics.Canvas canvas = new android.graphics.Canvas(returnedBitmap);
        // Get the view's background
        android.graphics.drawable.Drawable bgDrawable = getBackground();
        if (bgDrawable != null)
    ...
    public boolean saveToPath(String title, String pathOnSD) {
        ...
        android.graphics.Bitmap b = getChartBitmap();

        java.io.OutputStream stream = null;
        try {
            stream = new java.io.FileOutputStream(android.os.Environment.getExternalStorageDirectory().getPath()
                    + pathOnSD + "/" + title
                    + ".png");
             ...
             * JPEG.
             */
            b.compress(android.graphics.Bitmap.CompressFormat.PNG, 40, stream);
     ...
     */
    public boolean saveToGallery(String fileName, String subFolderPath, String fileDescription, android.graphics.Bitmap.CompressFormat format, int quality) {
        // restrain quality
        ...
        java.io.File extBaseDir = android.os.Environment.getExternalStorageDirectory();
        java.io.File file = new java.io.File(extBaseDir.getAbsolutePath() + "/DCIM/" + subFolderPath);
        if (!file.exists()) {
            if (!file.mkdirs()) {
                return false;
            }
        ...
        android.content.ContentValues values = new android.content.ContentValues(8);

        // store the details
        values.put(android.provider.MediaStore.Images.Media.TITLE, fileName);
        values.put(android.provider.MediaStore.Images.Media.DISPLAY_NAME, fileName);
        values.put(android.provider.MediaStore.Images.Media.DATE_ADDED, currentTime);
        values.put(android.provider.MediaStore.Images.Media.MIME_TYPE, mimeType);
        values.put(android.provider.MediaStore.Images.Media.DESCRIPTION, fileDescription);
        values.put(android.provider.MediaStore.Images.Media.ORIENTATION, 0);
        values.put(android.provider.MediaStore.Images.Media.DATA, filePath);
        values.put(android.provider.MediaStore.Images.Media.SIZE, size);

        return getContext().getContentResolver().insert(android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values) != null;
    }
    ...
    public boolean saveToGallery(String fileName, int quality) {
	    return saveToGallery(fileName, "", "MPAndroidChart-Library Save", android.graphics.Bitmap.CompressFormat.JPEG, quality);
    }

    /**
     * tasks to be done after the view is setup
     */
    protected java.util.ArrayList<Runnable> mJobs = new java.util.ArrayList<Runnable>();
     ...
     * @return
     */
    public java.util.ArrayList<Runnable> getJobs() {
        return mJobs;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = (int) com.github.mikephil.charting.utils.Utils.convertDpToPixel(50f);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (w > 0 && h > 0 && w < 10000 && h < 10000) {
            ...
            if (mLogEnabled)
                android.util.Log.i(LOG_TAG, "Setting chart dimens, width: " + w + ", height: " + h);
