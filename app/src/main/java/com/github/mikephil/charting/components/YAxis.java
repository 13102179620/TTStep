...
public class YAxis extends AxisBase {
	...
	protected com.github.mikephil.charting.formatter.YAxisValueFormatter mYAxisValueFormatter;
	...
	public float getRequiredWidthSpace(android.graphics.Paint p) {
		...
		return (float) com.github.mikephil.charting.utils.Utils.calcTextWidth(p, label) + getXOffset() * 2f;
	}
	...
	public float getRequiredHeightSpace(android.graphics.Paint p) {
		...
		String label = getLongestLabel();
		return (float) com.github.mikephil.charting.utils.Utils.calcTextHeight(p, label) + com.github.mikephil.charting.utils.Utils.convertDpToPixel(2.5f) * 2f + getYOffset();
	}
	 ...
	 * @param f
	 */
	public void setValueFormatter(com.github.mikephil.charting.formatter.YAxisValueFormatter f) {

		if (f == null)
			mYAxisValueFormatter = new com.github.mikephil.charting.formatter.DefaultYAxisValueFormatter(mDecimals);
		else
	 ...
	 * @return
	 */
	public com.github.mikephil.charting.formatter.YAxisValueFormatter getValueFormatter() {
	...
	public boolean needsDefaultFormatter() {
		if (mYAxisValueFormatter == null)
			return true;
		if (mYAxisValueFormatter instanceof com.github.mikephil.charting.formatter.DefaultValueFormatter)
			return true;
