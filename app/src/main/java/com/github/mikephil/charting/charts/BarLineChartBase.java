...
public abstract class BarLineChartBase<T extends com.github.mikephil.charting.data.BarLineScatterCandleBubbleData<? extends com.github.mikephil.charting.data.BarLineScatterCandleBubbleDataSet<? extends com.github.mikephil.charting.data.Entry>>>
    ...
    public BarLineChartBase(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public BarLineChartBase(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init() {
        ...
        mLeftAxisTransformer = new com.github.mikephil.charting.utils.Transformer(mViewPortHandler);
        mRightAxisTransformer = new com.github.mikephil.charting.utils.Transformer(mViewPortHandler);
        ...
        mGridBackgroundPaint = new android.graphics.Paint();
        mGridBackgroundPaint.setStyle(android.graphics.Paint.Style.FILL);
        // mGridBackgroundPaint.setColor(Color.WHITE);
        mGridBackgroundPaint.setColor(android.graphics.Color.rgb(240, 240, 240)); // light
        // grey
        ...
        mBorderPaint.setStrokeWidth(com.github.mikephil.charting.utils.Utils.convertDpToPixel(1f));
    }
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        if (mLogEnabled) {
            ...
            android.util.Log.i(LOG_TAG, "Drawtime: " + drawtime + " ms, average: " + average + " ms, cycles: "
                    + drawCycles);
        }
    }
    ...
    protected void prepareValuePxMatrix() {
        ...
        if (mLogEnabled)
            android.util.Log.i(LOG_TAG, "Preparing Value-Px Matrix, xmin: " + mXChartMin + ", xmax: "
    ...
    public void notifyDataSetChanged() {
        ...
        if (mDataNotSet) {
            if (mLogEnabled)
                android.util.Log.i(LOG_TAG, "Preparing... DATA NOT SET.");
            return;
        } else {
            if (mLogEnabled)
                android.util.Log.i(LOG_TAG, "Preparing...");
        }
...
//            mAxisRight.setValueFormatter(mDefaultFormatter);
    ...
    public void calculateOffsets() {
        ...
        if (!mCustomViewPortEnabled) {
            ...
            if (mLogEnabled) {
                android.util.Log.i(LOG_TAG, "offsetLeft: " + offsetLeft + ", offsetTop: " + offsetTop
        ...
        if (!mXAxis.isAxisModulusCustom()) {
            ...
            mXAxis.mAxisLabelModulus = (int) Math
                    .ceil((mData.getXValCount() * mXAxis.mLabelRotatedWidth)
                            / (mViewPortHandler.contentWidth() * values[android.graphics.Matrix.MSCALE_X]));

        }

        if (mLogEnabled)
            android.util.Log.i(LOG_TAG, "X-Axis modulus: " + mXAxis.mAxisLabelModulus +
    ...
    @Override
    protected float[] getMarkerPosition(com.github.mikephil.charting.data.Entry e, Highlight highlight) {
        ...
        if (this instanceof BarChart) {
            ...
            com.github.mikephil.charting.data.BarData bd = (com.github.mikephil.charting.data.BarData) mData;
     ...
     */
    protected void drawGridBackground(android.graphics.Canvas c) {
     ...
     * @return
     */
    public com.github.mikephil.charting.utils.Transformer getTransformer(AxisDependency which) {
     ...
     */
    public void zoomIn() {
        android.graphics.Matrix save = mViewPortHandler.zoomIn(getWidth() / 2f, -(getHeight() / 2f));
     ...
     */
    public void zoomOut() {
        android.graphics.Matrix save = mViewPortHandler.zoomOut(getWidth() / 2f, -(getHeight() / 2f));
        mViewPortHandler.refresh(save, this, true);
    ...
    public void fitScreen() {
        android.graphics.Matrix save = mViewPortHandler.fitScreen();
        mViewPortHandler.refresh(save, this, true);
    ...
    public void moveViewToX(float xIndex) {
        ...
        Runnable job = new com.github.mikephil.charting.jobs.MoveViewJob(mViewPortHandler, xIndex, 0f,
    ...
    public void moveViewToY(float yValue, AxisDependency axis) {
        ...
        Runnable job = new com.github.mikephil.charting.jobs.MoveViewJob(mViewPortHandler, 0f, yValue + valsInView / 2f,
    ...
    public void moveViewTo(float xIndex, float yValue, AxisDependency axis) {
        ...
        Runnable job = new com.github.mikephil.charting.jobs.MoveViewJob(mViewPortHandler, xIndex, yValue + valsInView / 2f,
                                                                         getTransformer(axis), this);
    ...
    public void centerViewTo(int xIndex, float yValue, AxisDependency axis) {
        ...
        Runnable job = new com.github.mikephil.charting.jobs.MoveViewJob(mViewPortHandler,
    ...
    public void setBorderWidth(float width) {
        mBorderPaint.setStrokeWidth(com.github.mikephil.charting.utils.Utils.convertDpToPixel(width));
    }
     ...
     * @return
     */
    public com.github.mikephil.charting.utils.PointD getValuesByTouchPoint(float x, float y, AxisDependency axis) {
        ...
        return new com.github.mikephil.charting.utils.PointD(xTouchVal, yTouchVal);
    }
     ...
     * @return
     */
    public com.github.mikephil.charting.utils.PointD getPixelsForValues(float x, float y, AxisDependency axis) {
        ...
        return new com.github.mikephil.charting.utils.PointD(pts[0], pts[1]);
    }
     ...
     * @return
     */
    public com.github.mikephil.charting.data.Entry getEntryByTouchPoint(float x, float y) {
     ...
     * @return
     */
    public com.github.mikephil.charting.data.BarLineScatterCandleBubbleDataSet<? extends com.github.mikephil.charting.data.Entry> getDataSetByTouchPoint(float x, float y) {
        Highlight h = getHighlightByTouchPoint(x, y);
        if (h != null) {
     ...
     * @param a
     */
    public void enableFiltering(com.github.mikephil.charting.data.filter.Approximator a) {
        mFilterData = true;
        // mApproximator = a;
    }
    ...
    public android.graphics.Paint getPaint(int which) {
        android.graphics.Paint p = super.getPaint(which);
        if (p != null)
            return p;
