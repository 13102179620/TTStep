...
public class ChartAnimator {
    ...
    public void animateXY(int durationMillisX, int durationMillisY, EasingFunction easingX,
        ...
        android.animation.ObjectAnimator animatorY = android.animation.ObjectAnimator.ofFloat(this, "phaseY", 0f, 1f);
        animatorY.setInterpolator(easingY);
        animatorY.setDuration(
                durationMillisY);
        android.animation.ObjectAnimator animatorX = android.animation.ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
