...
public abstract class Utils {
    ...
    public static void init(android.content.Context context) {
        ...
        if (context == null) {
            ...
            android.util.Log.e("MPChartLib-Utils"
    ...
    public static float convertDpToPixel(float dp) {
        ...
        android.util.DisplayMetrics metrics = mMetrics;
     ...
     * @return
     */
    public static int calcTextWidth(android.graphics.Paint paint, String demoText) {
     ...
     * @return
     */
    public static int calcTextHeight(android.graphics.Paint paint, String demoText) {
     ...
     * @return
     */
    public static FSize calcTextSize(android.graphics.Paint paint, String demoText) {
     ...
     * @return
     */
    public static int[] convertIntegers(java.util.List<Integer> integers) {
     ...
     * @return
     */
    public static String[] convertStrings(java.util.List<String> strings) {
     ...
     * @return
     */
    public static int getClosestDataSetIndex(java.util.List<SelectionDetail> valsAtIndex, float val,
                                             AxisDependency axis) {
     ...
     * @return
     */
    public static float getMinimumDistance(java.util.List<SelectionDetail> valsAtIndex, float val,
                                           AxisDependency axis) {
     ...
     * @return
     */
    public static android.graphics.PointF getPosition(android.graphics.PointF center, float dist, float angle) {
    ...
    public static void velocityTrackerPointerUpCleanUpIfNecessary(android.view.MotionEvent ev,
    ...
    public static void drawText(android.graphics.Canvas c, String text, float x, float y, android.graphics.Paint paint, android.graphics.PointF anchor, float angleDegrees) {
        ...
        android.graphics.Paint.Align originalTextAlign = paint.getTextAlign();
