...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> {
    ...
    private int mBarShadowColor = android.graphics.Color.rgb(215, 215, 215);
    ...
    public BarDataSet(java.util.List<BarEntry> yVals, String label) {
        super(yVals, label);

        mHighLightColor = android.graphics.Color.rgb(0, 0, 0);
    ...
    public DataSet<BarEntry> copy() {
        ...
        java.util.List<BarEntry> yVals = new java.util.ArrayList<BarEntry>();
     ...
     */
    private void calcEntryCountIncludingStacks(java.util.List<BarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(java.util.List<BarEntry> yVals) {
