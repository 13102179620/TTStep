...
public class LimitLine extends ComponentBase {
    ...
    private int mLineColor = android.graphics.Color.rgb(237, 91, 91);

    /** the style of the label text */
    private android.graphics.Paint.Style mTextStyle = android.graphics.Paint.Style.FILL_AND_STROKE;
    ...
    public void setLineWidth(float width) {
        ...
        if (width > 12.0f)
            width = 12.0f;
        mLineWidth = com.github.mikephil.charting.utils.Utils.convertDpToPixel(width);
    }
